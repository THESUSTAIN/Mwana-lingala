...
SPA_META_OVERRIDES: list[tuple[str, dict]] = [
    ("/apprendre-le-lingala", {
        "title": "Apprendre le lingala — cours facile pour adultes (A1 à B2) et enfants | Mwana Lingala",
        "description": "Apprendre le lingala : cours facile pour adultes débutants, et pour les enfants de la famille. Test de niveau gratuit, leçons à votre rythme, phrases de voyage, coach IA. La méthode douce de Mwana Lingala — pour la diaspora ET tous les passionnés. 100 % en ligne.",
        "keywords": "apprendre le lingala, cours lingala facile, cours de lingala en ligne, apprendre lingala adulte, apprendre lingala enfant, méthode lingala débutant, lingala A1 A2 B1, apprendre lingala gratuit, parler lingala",
        "og_image": f"{PROD_BASE}/images/hero-apprendre-pour-soi.png",
    }),
    ("/phrases-voyage", {
        "title": "50 phrases de lingala pour voyager (adultes & familles) | Kinshasa / Brazzaville",
        "description": "50 phrases utiles en lingala pour voyager au Congo, pour adultes et familles : aéroport, hôtel, marché, taxi, restaurant, urgences. Avec audio natif et traduction française. Gratuit.",
        "keywords": "phrases lingala voyage, lingala kinshasa, lingala brazzaville, expressions lingala touriste, voyage congo lingala, apprendre lingala voyage adulte",
        "og_image": f"{PROD_BASE}/images/hero-tarifs.png",
    }),
    ("/test-niveau", {
        "title": "Test de niveau lingala gratuit pour adultes et enfants (A1, A2, B1, B2) | Mwana Lingala",
        "description": "Évaluez votre niveau de lingala (ou celui de votre enfant) en 2 minutes. 10 questions du débutant à l'avancé. Recevez votre programme d'apprentissage personnalisé. 100 % gratuit, sans inscription.",
        "keywords": "test de niveau lingala, test lingala adulte, test lingala enfant, niveau lingala A1 A2 B1, évaluation lingala, quiz lingala, apprendre lingala niveau",
        "og_image": f"{PROD_BASE}/images/hero-test-niveau.png",
    }),
    ("/traduction-lingala", {
        "title": "Traducteur Français ↔ Lingala gratuit en ligne — pour adultes et enfants | Mwana Lingala",
        "description": "Traduisez du français vers le lingala (et inversement) gratuitement. Audio natif, exemples du quotidien, dictionnaire interactif — pour apprendre la langue lingala en ligne, en famille ou pour soi (adulte).",
        "keywords": "traduction lingala, traducteur lingala, lingala français, dictionnaire lingala, traduire lingala, apprendre le lingala, lingala adulte, lingala enfant",
        "og_image": f"{PROD_BASE}/og-default.jpg",
    }),
    ("/pourquoi-lingala", {
        "title": "Pourquoi apprendre le lingala ? Pour soi (adulte), pour ses enfants, pour ses racines | Mwana Lingala",
        "description": "Apprendre le lingala c'est transmettre une identité, une famille, des racines — que vous l'apprenez pour vous (adulte) ou pour vos enfants. Découvrez l'importance de cette langue bantoue parlée par plus de 40 millions de personnes.",
        "keywords": "pourquoi apprendre le lingala, langue lingala, transmission lingala, diaspora congolaise, langues bantoues, apprendre lingala adulte, lingala enfant",
    ...
    ("/tarifs", {
        "title": "Tarifs — Apprendre le lingala (adultes & familles) gratuitement ou en Premium | Mwana Lingala",
        "description": "Démarrez gratuitement avec 20 mots offerts et le test de niveau, pour adultes ET enfants. Premium 12,99 €/mois pour débloquer 87 mots, le coach IA, les phrases voyage et le programme hebdomadaire. Sans engagement.",
        "keywords": "tarif lingala, prix application lingala, abonnement mwana lingala, premium lingala, apprendre lingala gratuit, lingala adulte, lingala enfant",
        "og_image": f"{PROD_BASE}/images/hero-tarifs.png",
    }),
    ("/mission", {
        "title": "Contribuer à Mwana Lingala — Mission Lingala | Adultes apprenants, parents, communauté",
        "description": "Aidez la communauté lingala (adultes apprenants ET familles) : enregistrez votre voix, validez des traductions, proposez de nouveaux mots. Récompenses en crédits IA.",
        "keywords": "mission lingala, contribuer lingala, communauté lingala, voix lingala, lingala adulte, lingala enfant",
        "og_image": f"{PROD_BASE}/og-default.jpg",
    }),
    ("/blog", {
        "title": "Blog Mwana Lingala — Méthode adulte, transmission enfant, culture | Apprendre le lingala",
        "description": "Articles experts sur l'apprentissage du lingala : méthode pour adultes débutants, transmission familiale aux enfants, culture congolaise, voyage, langues bantoues. Mis à jour chaque semaine.",
        "keywords": "blog lingala, article lingala, apprendre le lingala, conseils lingala adulte, transmission lingala enfant, culture congolaise",
        "og_image": f"{PROD_BASE}/og-default.jpg",
    }),
    ("/contact", {
        "title": "Contact — Mwana Lingala | Apprendre le lingala (adultes & familles)",
        "description": "Une question, un partenariat, une idée — adulte apprenant ou parent ? Écrivez à l'équipe Mwana Lingala. Réponse sous 24 h.",
        "keywords": "contact mwana lingala, support apprendre lingala, partenariat éducation lingala, lingala adulte, lingala enfant",
