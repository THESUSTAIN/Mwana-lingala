    ...
    <PublicLayout>
      {stage === "intro" && (
        <PublicHero
          ...
          imageSrc="/images/hero-test-niveau.png"
          imageAlt="Test de niveau lingala — jeune femme apprenant le lingala depuis chez elle, illustration aquarelle pastel inclusive"
        >
          <button
