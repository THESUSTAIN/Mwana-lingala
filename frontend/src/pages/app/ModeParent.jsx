...
export default function ModeParent() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
      ...
      {/* Progress card */}
      <div className="ml-card mt-6 p-6 bg-white grid sm:grid-cols-[1fr_auto] gap-4 items-center" data-testid="parent-progress">
        <div>
          <div className="text-sm font-bold text-leaf">Progression globale</div>
          <div className="text-2xl font-black">{progress.count} / {progress.total} mots</div>
          <div className="h-3 bg-sand-100 rounded-full mt-3 overflow-hidden">
            <div className="h-full bg-leaf transition-all" style={{ width: `${progress.percent}%` }} />
          </div>
        </div>
        <div className="text-4xl font-black text-brick">{progress.percent}%</div>
      </div>
